...
# Load the dataset
def logisticRegressionModel(data, field_to_train, fields_to_encode):
    ...
    dump(label_encoders, 'lr_label_encoders.joblib')
...
def estimateXG(collection, query, fields_to_encode):
    ...
    label_encoders = load('lr_label_encoders.joblib')
...
logisticRegressionModel(df, fields_to_train, fields_to_encode)
