...
def gBoostModel(data, fields_to_train, fields_to_encode):
    ...
    dump(model, 'gb_model.joblib')
    dump(label_encoders, 'gb_label_encoders.joblib')
...
def estimateXG(collection, query, fields_to_encode):
    ...
    label_encoders = load('gb_label_encoders.joblib')
